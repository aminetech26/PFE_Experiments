...
def main():
    ...
    parser.add_argument("--model-path", type=str, default=str(PROJECT_ROOT / "experiments/checkpoints/lstmvae/lstmvae_best.keras"))
    ...
    parser.add_argument("--metrics-path", type=str, default=str(PROJECT_ROOT / "experiments/metrics/lstmvae_results.json"))
